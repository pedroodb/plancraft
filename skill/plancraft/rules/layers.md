...
| `dimensions` | 0.13mm | Dimension lines, ticks, measurement text (auto-generated) |
| `labels` | 0.13mm | Room labels (auto-generated from room names) |

Layers are automatically assigned based on the element type. Dimensions and labels are auto-generated by the renderer from room geometry — they are not part of the .pc file.
